...
- connect to Telegram, Discord, Slack, WeChat, Zalo, Email, Mattermost, and other chat apps
...
- **Chat-native reach**: WebUI, API, Telegram, Feishu, Slack, Discord, Teams, Zalo, email, and Mattermost.
